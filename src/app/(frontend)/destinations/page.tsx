...
export default function DestinationsPage() {
  ...
  return (
    <div className="w-full flex flex-col items-center">
      ...
      {/* ── Section 2: United States at a Glance ── */}
      <div className="w-full bg-[#F9F9F8] py-12 md:py-10 flex flex-col items-center mt-10">
      ...
      {/* ── Section 3: Why Choose the USA ── */}
      <div className="w-full bg-[#ffffff] py-12 md:py-16 flex flex-col items-center mt-12">
        <div className="w-full max-w-[1235px] mt-24 md:mt-32 px-4 md:px-0 flex flex-col lg:flex-row justify-between items-center gap-12">
          {/* Left Column: Image */}
      ...
      {/* ── Section 4: Immigration Pathways Grid ── */}
      ...
      {/* ── Section 5: Why Apply with HOF Migration ── */}
      <div className="w-full max-w-[1235px] mt-16 md:mt-0 px-6 md:px-0 md:py-20 flex flex-col items-center gap-8">
      ...
      {/* ── Section 6: Immigration Process timeline ── */}
      ...
      {/* ── Section 7: Proven by What Our Clients Say (Testimonials) ── */}
      ...
      {/* ── Section 8: Friendly Asked Questions ── */}
